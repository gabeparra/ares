...
const getRedirectUri = () => {
  ...
  if (!protocol || !host) {
    ...
    throw new Error("Unable to determine redirect_uri. Please set VITE_AUTH0_REDIRECT_URI in .env file");
  }
  ...
  try {
    ...
    throw new Error(`Invalid redirect_uri: ${redirectUri}. Please set VITE_AUTH0_REDIRECT_URI in .env file`);
  }
};
